...
export default function SignIn() {
  ...
  const handleForgotPassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // This line sends the reset email to the 'email' state variable
      ...
      // Keep generic error for security
      setError("Failed to send reset email. Please try again.");
      console.error("Forgot password error:", err); // Log the actual error for debugging
    } finally {
      setIsLoading(false);
    }
  };
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      id="email"
                      type="email"
                      placeholder="animeshbaral10@gmail.com" // Placeholder suggests the email
                      value={email} // The actual email used comes from state
                      onChange={(e) => setEmail(e.target.value)} // State updates on input change
